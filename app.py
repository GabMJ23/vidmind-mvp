...
def main():
    ...
    with col2:
        st.markdown("<h1 style='text-align: center; font-size: 3em; letter-spacing: 8px;'>VIDMIND</h1>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center; color: rgba(255,255,255,0.6); font-size: 1.2em;'>L'Intelligence de Votre Créativité</p>", unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        page = st.selectbox(
            "Choisir une vue",
            ["🏠 Dashboard", "💬 Gestion Commentaires", "📊 Analytics", "🤖 Chat IA"]
        )
